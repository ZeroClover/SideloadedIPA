...
from sideloadedipa.legacy.exercise_zsign_backend import TARGETS
...
def compare_summaries(linux: Mapping[str, Any], macos: Mapping[str, Any]) -> dict[str, Any]:
...
def main() -> int:
    try:
        ...
        result = compare_summaries(
            load_summary(args.linux_summary), load_summary(args.macos_summary)
        )
