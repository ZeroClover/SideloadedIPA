...
class ErrorCode(StrEnum):
    ...
    SOURCE_TRANSPORT_INVALID = "source.transport_invalid"
    SOURCE_REDIRECT_REJECTED = "source.redirect_rejected"
    SOURCE_TRANSFER_LIMIT = "source.transfer_limit"
    SOURCE_ADVERTISED_SIZE_MISMATCH = "source.advertised_size_mismatch"
    SOURCE_RETRY_EXHAUSTED = "source.retry_exhausted"
